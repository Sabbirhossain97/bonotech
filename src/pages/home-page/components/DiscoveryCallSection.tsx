...
const calendarDays: CalendarDay[] = [
    { label: "Mon", date: 14, value: "2026-09-14" },
    { label: "Tue", date: 15, value: "2026-09-15" },
    { label: "Wed", date: 16, value: "2026-09-16" },
    { label: "Thu", date: 17, value: "2026-09-17" },
    { label: "Fri", date: 18, value: "2026-09-18" },
    { label: "Sat", date: 19, value: "2026-09-19" },
    { label: "Sun", date: 20, value: "2026-09-20" },
];
...
const DiscoveryCallSection = () => {
    ...
    const selectedDateLabel = useMemo(() => {
        const day = calendarDays.find((item) => item.value === selectedDate);

        if (!day) return "";

        return `${day.label}, Sep ${day.date}`;
    }, [selectedDate]);
    ...
    const fieldClass =
        "h-[42px] w-full rounded-[4px] border border-[#9B72BE]/20 bg-[#160B25]/70 px-3 text-[12px] text-[#F1E8F8] outline-none transition placeholder:text-[#806F8E] focus:border-[#A574D5]/70 focus:ring-2 focus:ring-[#A574D5]/10";

    const labelClass =
        "mb-[7px] block text-[10px] font-medium tracking-[-0.01em] text-[#C0AFCB]";
                    ...
                    >
                        ...
                        <div className="border-b border-[#B695CE]/15 p-6 sm:p-8 lg:border-b-0 lg:border-r lg:p-[36px]">
                            <div className="mb-7 flex gap-4">
                                <span className="pt-[3px] text-[10px] tracking-[0.08em] text-[#9A82AC]">
                                    01
                                </span>

                                <div>
                                    <h3 className="text-[19px] font-light tracking-[-0.04em] text-[#F1EAF6]">
                                        A Little About Your Business
                                    </h3>

                                    <p className="mt-2 text-[10px] leading-[1.5] text-[#8F819A]">
                            ...
                            <div className="grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                                ...
                                <label>
                                    <span className={labelClass}>
                                        Your role{" "}
                                        <small className="ml-1 text-[9px] font-normal text-[#74677D]">
                                            Optional
                                        </small>
                                    </span>
                                ...
                                <label className="sm:col-span-2">
                                    ...
                                    <select
                                        value={form.focus}
                                        onChange={(e) =>
                                            updateField("focus", e.target.value)
                                        }
                                        name="focus"
                                        className={fieldClass}
                                    >
                                ...
                                <label className="sm:col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        className="min-h-[92px] w-full resize-none rounded-[4px] border border-[#9B72BE]/20 bg-[#160B25]/70 px-3 py-3 text-[12px] leading-[1.5] text-[#F1E8F8] outline-none transition placeholder:text-[#806F8E] focus:border-[#A574D5]/70 focus:ring-2 focus:ring-[#A574D5]/10"
                                    />
                                </label>
                            </div>

                            <p className="mt-9 text-[9px] leading-[1.6] text-[#96899F]">
                        ...
                        <div className="p-6 sm:p-8 lg:p-[36px]">
                            ...
                            <div className="flex items-center justify-between">
                                <div className="inline-flex rounded-[4px] bg-[#170C26] p-[3px]">
                                    <button
                                        ...
                                        className={`rounded-[3px] px-4 py-2 text-[10px] transition ${calendarView === "week"
                                    ...
                                    <button
                                        ...
                                        className={`rounded-[3px] px-4 py-2 text-[10px] transition ${calendarView === "month"
                                                ? "bg-[#E2CBF4] text-[#2D183D]"
                                                : "text-[#A493B0] hover:text-white"
                                            }`}
                                    >
                                ...
                                <button
                                    type="button"
                                    className="text-[10px] text-[#85778F] transition hover:text-white"
                                >
                                    Today
                                </button>
                            </div>
                                ...
                                {calendarDays.map((day) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`rounded-[5px] border px-1 py-3 text-center transition ${selected
                                                    ? "border-[#9C6CC7]/40 bg-[#3A2051]/35"
                                                    : "border-transparent hover:border-[#714F89]/25 hover:bg-[#22102F]/40"
                                                }`}
                                        >
                                            <span className="block text-[8px] text-[#6F6278]">
                                                {day.label}
                                            </span>

                                            <span
                                                className={`mt-2 block text-[12px] ${selected
                                                        ? "text-[#E4D8EB]"
                                                        : "text-[#83748D]"
                                                    }`}
                                            >
                            ...
                            {/* Options */}
                            <div className="mt-5 flex items-end justify-between border-t border-[#A37ABE]/10 pt-4">
                                <label className="max-w-[180px] flex-1">
                                    <span className="mb-2 block text-[9px] text-[#75687E]">
                                        Time zone
                                    </span>
                                    ...
                                    <select
                                        ...
                                        className="w-full bg-transparent text-[10px] text-[#AEA0B7] outline-none"
                                    >
                                        {timeZones.map((zone) => (
                                            <option
                                                key={zone}
                                ...
                                >
                                    <button
                                        ...
                                        className={`rounded-[3px] px-2 py-1.5 text-[9px] ${clockFormat === "12"
                                    ...
                                    <button
                                        ...
                                        className={`rounded-[3px] px-2 py-1.5 text-[9px] ${clockFormat === "24"
                                                ? "bg-[#2C173C] text-[#D8C8E4]"
                                                : "text-[#73647E]"
                                            }`}
                                    >
                            ...
                            <p className="mt-5 text-[9px] text-[#776A81]">
                                Preview schedule · Live booking is not connected yet.
                            </p>

                            {/* Slots */}
                            <div className="mt-4 flex items-center justify-between">
                                <h4 className="text-[11px] font-medium text-[#B6A7C0]">
                                    {selectedDateLabel}
                                </h4>

                                <span className="text-[9px] text-[#716577]">
                                    30 min
                                </span>
                            </div>
                            ...
                            <div className="mt-3 max-h-[142px] space-y-1.5 overflow-y-auto pr-1 [scrollbar-width:thin]">
                                {timeSlots.map((slot) => (
                                    <button
                                        ...
                                        className={`flex w-full items-center justify-between rounded-[4px] border px-3 py-2.5 text-left text-[10px] transition ${selectedTime === slot
                                                ? "border-[#9B70C7]/50 bg-[#321C45] text-[#F0E6F8]"
                                                : "border-transparent text-[#86798F] hover:border-[#704E88]/25 hover:bg-[#190C25]"
                                            }`}
                                    >
                                        <span>{slot}</span>
                                        <span className="text-[8px] text-[#65596C]">
                                            30 min
                                        </span>
                                    </button>
                                ))}
                            ...
                            <div className="mt-4 border-t border-[#A37ABE]/10 pt-4">
                                <p className="mb-4 text-[9px] text-[#887A90]">
                                    {selectedTime
                                        ? `${selectedDateLabel} · ${selectedTime} · ${timeZone}`
                                ...
                                <button
                                    ...
                                    className={`flex h-[44px] w-full items-center justify-between rounded-[4px] px-4 text-[11px] font-medium transition ${isFormValid
                                            ? "bg-[#DDC7F0] text-[#2C183B] hover:bg-[#E8D7F7]"
                                            : "cursor-not-allowed bg-[#DCC6ED] text-[#5B4967] opacity-90"
                                        }`}
                                >
            ...
            {showReview && (
                <div className="fixed inset-0 z-[100] grid place-items-center bg-black/70 p-5 backdrop-blur-md">
                    <div className="relative w-full max-w-[520px] rounded-[6px] border border-[#B48BD0]/25 bg-[#160C24] p-7 text-white shadow-[0_30px_100px_rgba(0,0,0,.55)] sm:p-9">
                        ...
                        <p className="text-[10px] font-medium uppercase tracking-[0.16em] text-[#A995BB]">
                            Your Discovery Call
                        </p>
                        ...
                        <div className="mt-5 rounded-[5px] border border-[#9C76B8]/15 bg-[#21102F] p-4">
                            <strong className="text-[12px] text-[#E5D6EF]">
                                Booking is not live yet.
                            </strong>

                            <p className="mt-1 text-[11px] leading-[1.5] text-[#94869C]">
                                Your details have not been sent and this time has not been
                                reserved.
                            </p>
                        </div>
                        ...
                        <div className="mt-6 flex gap-3">
                            ...
                            <button
                                type="button"
                                disabled
                                className="h-11 flex-1 cursor-not-allowed rounded-[4px] bg-[#DCC8EC]/25 text-[11px] text-[#8E7C99]"
                            >
