...
const VideoControl = ({ videoRef, isPaused, onToggle, label }: VideoCardProps) => {
    return (
        <button type="button" onClick={onToggle} aria-label={`${isPaused ? "Play" : "Pause"} ${label} video`} aria-pressed={isPaused} className="absolute right-4 top-4 z-30 grid h-9 w-9 place-items-center rounded-full border border-white/20 bg-[#11091d]/50 text-white backdrop-blur-md transition hover:bg-[#211233]/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c9a8ff]">
            {isPaused ? (
...
const AboutImpactSection = () => {
    ...
    useEffect(() => {
        ...
        setups.forEach(({ card, video, getPaused, setPaused }) => {
            ...
            const sync = () => {
                const shouldPause = !visible || document.hidden || getPaused() || reducedMotion.matches;
    ...
    return (
        <section id="about-bonotech" aria-labelledby="about-title" className="relative isolate overflow-hidden bg-[#12091d] px-5 py-20 sm:px-6 sm:py-24 lg:px-8 lg:py-[110px]">
            {/* Background */}
            <div aria-hidden="true" className="pointer-events-none absolute inset-0">
                <div className="absolute left-1/2 top-[47%] h-[105%] w-[150%] -translate-x-1/2 -translate-y-1/2 rounded-[50%] bg-[radial-gradient(ellipse_at_center,rgba(151,109,235,0.95)_0%,rgba(130,87,220,0.86)_30%,rgba(87,53,157,0.72)_53%,rgba(35,19,59,0.40)_72%,transparent_88%)] blur-[2px]" />
                <div className="absolute left-1/2 top-[50%] h-[70%] w-[95%] -translate-x-1/2 -translate-y-1/2 rounded-[50%] bg-[#9a72ec]/20 blur-[110px]" />
                <div className="absolute inset-x-0 top-0 h-[110px] bg-gradient-to-b from-black via-black/85 to-transparent" />
                <div className="absolute inset-x-0 bottom-0 h-[120px] bg-gradient-to-t from-black via-black/75 to-transparent" />
            </div>
            ...
            <div className="relative z-10 mx-auto w-full max-w-[1200px]">
                ...
                <header className="mx-auto mb-10 max-w-[850px] text-center sm:mb-12 lg:mb-[52px]">
                    ...
                    <h2 id="about-title" className="text-[38px] font-light leading-[1.04] tracking-[-0.05em] text-white sm:text-[48px] md:text-[56px] lg:text-[60px]">
                        Built for Business
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-[1fr_1fr_1fr] lg:grid-rows-[minmax(370px,1fr)_118px] lg:gap-[18px]">
                    {/* Projects */}
                    <article ref={projectsCardRef} aria-labelledby="projects-title" className="group relative isolate flex min-h-[520px] overflow-hidden rounded-[5px] border border-white/15 bg-[#241038] md:min-h-[570px] lg:row-span-2 lg:min-h-[560px]">
                        <div className="absolute inset-0 z-0 overflow-hidden">
                            <video ref={projectsVideoRef} src={projectsBackground} muted loop playsInline preload="metadata" tabIndex={-1} className="h-full w-full object-cover opacity-90" />
                        ...
                        <VideoControl videoRef={projectsVideoRef} isPaused={projectsPaused} onToggle={toggleProjectsVideo} label="project" />

                        <div className="relative z-10 mt-auto w-full p-7 sm:p-8 lg:p-[30px]">
                            <h3 id="projects-title" className="m-0 font-normal text-white">
                                <span className="block text-[86px] font-light leading-[0.88] tracking-[-0.075em] sm:text-[96px] lg:text-[104px]">
                                    23<span className="text-[0.55em]">+</span>
                                </span>
                                ...
                                <span className="mt-8 block max-w-[230px] text-[19px] font-light leading-[1.42] tracking-[-0.045em] text-[#f3eafb] sm:text-[20px]">
                                    ...
                                    <strong className="font-semibold">6 months.</strong>
                                </span>
                            </h3>
                        </div>
                    </article>
                    ...
                    <article aria-labelledby="commitment-title" className="relative isolate flex min-h-[600px] flex-col overflow-hidden rounded-[5px] border border-white/15 bg-[#44525b] p-5 text-white sm:p-6 md:min-h-[570px] lg:row-span-2 lg:min-h-[560px]">
                        <img src={ludovicoMassari} alt="Ludovico Massari beside a mountain river" loading="lazy" decoding="async" className="absolute inset-0 h-full w-full object-cover object-[55%_48%]" />
                        ...
                        <div className="relative z-10 flex items-center justify-between px-1 pt-1">
                            <h3 id="commitment-title" className="text-[16px] font-light tracking-[-0.035em] sm:text-[18px]">
                                Measurable Commitment
                            </h3>

                            <span aria-hidden="true" className="relative h-[14px] w-[14px]">
                        ...
                        <p className="relative z-10 mt-3 text-[70px] font-light leading-none tracking-[-0.075em] sm:text-[78px] lg:text-[82px]">
                            100<span className="text-[0.58em]">%</span>
                        </p>
                        ...
                        <figure className="relative z-10 mt-auto rounded-[4px] bg-[#faf8fd] p-6 text-[#242128] shadow-[0_14px_35px_rgba(10,5,20,0.22)] sm:p-7">
                            <blockquote className="m-0 text-[17px] leading-[1.52] tracking-[-0.035em] sm:text-[18px]">
                                <p>
                                    ...
                                    It&apos;s efficient, intelligent, and seamless.”
                                </p>
                            </blockquote>
                            ...
                            <figcaption className="mt-5 flex items-center justify-between gap-4 border-t border-[#ddd4e7] pt-4">
                                ...
                                <img src={divcLogo} alt="DIVC" loading="lazy" decoding="async" className="h-auto w-[58px] flex-shrink-0 sm:w-[64px]" />
                            </figcaption>
                        </figure>
                    </article>

                    {/* Data */}
                    <article ref={dataCardRef} aria-labelledby="data-title" className="relative isolate flex min-h-[365px] flex-col overflow-hidden rounded-[5px] border border-white/15 bg-[#250d3d] p-7 text-white sm:p-8 lg:min-h-0">
                        <div className="absolute inset-0 z-0 overflow-hidden">
                            <video ref={dataVideoRef} src={dataMotion} muted loop playsInline preload="metadata" tabIndex={-1} className="h-full w-full object-cover opacity-90 grayscale" />
                        ...
                        <VideoControl videoRef={dataVideoRef} isPaused={dataPaused} onToggle={toggleDataVideo} label="data" />

                        <h3 id="data-title" className="relative z-10 text-[17px] font-light tracking-[-0.035em] sm:text-[18px]">
                            Data Points
                        </h3>
                        ...
                        <p className="relative z-10 mt-5 whitespace-nowrap text-[68px] font-light leading-none tracking-[-0.075em] sm:text-[76px] lg:text-[80px]">
                            520k<span className="text-[0.55em]">+</span>
                        </p>
                    ...
                    {/* CTA */}
                    <button type="button" className="group relative isolate flex min-h-[118px] items-center justify-between overflow-hidden rounded-[5px] border border-white/15 bg-[#211033] px-7 text-left text-white transition hover:border-[#c6a1f0]/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#c9a5f7] sm:px-8 lg:min-h-0">
                        ...
                        <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" className="relative z-10 h-6 w-6 transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">
